...
Today I migrated my blog from (GitHub-driven) Jekyll to instead use [the blog capabilities of Roq](https://iamroq.dev/posts/roq-with-blogs/), a static site generator driven by Quarkus.
...
I basically followed the steps in the [Roq with Blogs](https://iamroq.dev/posts/roq-with-blogs/) post. All two of them.
...
Turns out, the `layout` front matter value had a slightly different syntax than what I used with Jekyll. My old blog had:
...
Whereas at the time, Roq preferred the `layout` argument to be more like this:
